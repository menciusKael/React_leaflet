...
import md_ajax from "md_midware/md-service/md-ajax"; //请求数据封装
...
//const host = 'http://192.168.19.85'
const host = "http://192.168.0.100";
const port = "80";
const ctx = host + ":" + port;  //主机+端口号=完整url
let lastTime;
/**
 * 1.格式化风圈数据
...
const formatCircleData = data => {
  ...
  for (let i = 0; i < radius.length; i++) {
    ...
    console.log(ele); // radius7，radius10，radius12
    if (data[ele]) {
      console.log(data[ele]);// 250,250,100,250  0,0,0,0  0,0,0,0
      let strArr = data[ele].split(",");
      console.log(strArr);// 数组 元素为数字字符串，逗号隔开
 ...
 */
  handleSelectAll(selected, selectedRows, changeRows) {
   ...
   //["201719", "201718", "201717", "201716", "201715"]
